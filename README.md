...
Repository یکتای Post با Adapter ناهمگام MongoDB آماده‌اند. اتصال Telegram،
پردازش هوش مصنوعی و Workerهای اجرایی هنوز ساخته نشده‌اند.
...
MongoDB آزمایشی محلی را روی loopback و پورت `27017` اجرا کنید؛ سپس تست T004 را
با این فرمان اجرا کنید:
...
قرار دارند. هنوز Entry Point اجرایی یا Composition Root اتصال MongoDB وجود
ندارد.
