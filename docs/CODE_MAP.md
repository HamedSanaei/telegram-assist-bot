...
هنوز Telegram Adapter، AI Adapter، Worker، Presentation handler یا Entry Point
اجرایی وجود ندارد.
...
| `scripts/check_distribution.py` | اعتبارسنجی دقیق Wheel، sdist، metadata و حضور ماژول‌های Config/Post Domain/Observability/Retry |
