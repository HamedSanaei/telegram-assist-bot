...
آستانه معنایی اولیه و رفتار نهایی Duplicate هنوز در معماری ابهام بازند؛ پیاده‌سازی نباید مقدار یا Default آن‌ها را حدس بزند و تکمیل Task منوط به Configuration/تصمیم مستند است.
