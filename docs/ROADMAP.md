...
- منبع نیازمندی فعلی `REQUIREMENTS.md` در ریشه مخزن است.
...
ابهام‌های مؤثر بر اجرا در `docs/ARCHITECTURE.md `17` ثبت شده‌اند و هنگام فعال‌شدن Task مربوط باید حل شوند.
