...
- تنها یک Task می‌تواند `Active` باشد؛ اکنون فقط T004 فعال است.
...
| [T004](tasks/T004-mongodb-idempotent-posts.md) | MongoDB و Persistence یکتای Post | T002، T003 | `5.3`، `5.4` | Active |
